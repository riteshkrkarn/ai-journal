  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement): { gl: WebGLRenderingContext; ext: WebGLExtensions } {
      ...
      if (isWebGL2) {
        ...
        supportLinearFiltering = !!gl!.getExtension('OES_texture_half_half_linear');
      }
    ...
    function splatPointer(pointer: Pointer) {
      ...
      splat(pointer.texcoordX, pointer.texcoordY, dx, dy, pointer.color as any);
    }
    ...
    function updatePointerDownData(pointer: Pointer, id: number, posX: number, posY: number) {
      ...
      pointer.deltaX = 0;
      pointer.deltaY = 0;
      pointer.color = generateColor() as any;
    }

    function updatePointerMoveData(pointer: Pointer, posX: number, posY: number, color: any) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
    ...
    function generateColor(): Color {
      // Choose randomly between #4BBEBB and #016BFF
      const colors = [
        { r: 0x4B / 255, g: 0xBE / 255, b: 0xBB / 255 }, // #4BBEBB
        { r: 0x01 / 255, g: 0x6B / 255, b: 0xFF / 255 }  // #016BFF
      ];
