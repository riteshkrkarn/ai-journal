...
const Logo: React.FC = () => (
  <div className="flex items-center space-x-2">
    <svg
      className="w-6 h-6 sm:w-8 sm:h-8 text-[#4BBEBB]"
      viewBox="0 0 24 24"
      fill="currentColor"
    >
        ...
        try {
          ...
          if (data.type === "auth") {
            if (data.status === "authenticated") {
              ...
              setMessages((prev) => {
                // Check if connection message already exists
            ...
            // AI response - stream it word by word
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex font-['Inter',sans-serif] overflow-hidden">
      ...
      <div
        ...
        } md:translate-x-0 fixed md:static inset-y-0 left-0 z-50 w-64 sm:w-72 md:w-64 bg-[#1a1a1a]/95 md:bg-[#1a1a1a]/80 backdrop-blur-xl border-r border-gray-800/50 flex flex-col transition-transform duration-300 overflow-hidden`}
      >
        {/* Logo */}
        ...
        <div className="flex-1 p-3 sm:p-4 space-y-1 sm:space-y-2 overflow-y-auto">
          ...
          >
            ...
            <span className="text-sm sm:text-base font-medium bg-clip-text text-transparent bg-gradient-to-r from-[#016BFF] to-[#4BBEBB] truncate">
              Journal / Chat
            </span>
          </button>
          ...
          <button className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl hover:bg-gray-800/50 transition-all group">
            ...
            <span className="text-sm sm:text-base font-medium text-gray-400 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-[#016BFF] group-hover:to-[#4BBEBB] truncate">
              Goal
            </span>
          </button>
        ...
        <div className="p-3 sm:p-4 border-t border-gray-800/50 space-y-1 sm:space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl hover:bg-red-900/30 transition-all group border border-transparent hover:border-red-500/30"
          >
            <LogOut className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-red-400 flex-shrink-0" />
            <span className="text-sm sm:text-base font-medium text-gray-400 group-hover:text-red-400 truncate">
              Logout
            </span>
          </button>
        </div>
            ...
            <div className="w-full max-w-3xl space-y-4 sm:space-y-6">
                ...
                >
                  <div
                    className={`max-w-[90%] sm:max-w-[85%] ${
                      message.isUser ? "ml-4 sm:ml-12" : "mr-4 sm:mr-12"
                    }`}
                  >
                    {!message.isUser && (
              ...
              {isWaitingResponse && (
                <div className="flex justify-start">
                  <div className="max-w-[90%] sm:max-w-[85%] mr-4 sm:mr-12">
                    <div className="flex items-center gap-2 mb-2">
